...
it ('템플릿 조회 테스트', async () => {
    const response = await APIAuthRequest("http://127.0.0.1:8080/api/templates","GET",{}, token)
...
it ('사용자 조회 테스트', async () => {
    const response = await APIAuthRequest("http://127.0.0.1:8080/api/usernames","GET",{}, token)
...
it ('전체 요청 목록 테스트', async () => {
    const response = await APIAuthRequest("http://127.0.0.1:8080/api/requests","GET",{}, token)
...
it ('요청 목록 상세 테스트', async () => {
    const response = await APIAuthRequest("http://127.0.0.1:8080/api/requests/2","GET",{}, token)
